          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <article className="bg-white dark:bg-slate-900 p-6 rounded-lg shadow-sm">
              <div className="mb-4 overflow-hidden rounded-lg">
                <img 
                  src="/gcd-cover.png" 
                  alt="Grand Central Dispatch Cover" 
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                An in-depth exploration of Apple's concurrency framework for managing parallel tasks in iOS applications.
              </p>
              <div className="flex items-center justify-between">
                ...
                <a 
                  href="https://medium.com/@gemiciemre/grand-central-dispatch-gcd-8103e77c34df" 
                  target="_blank" 
                  rel="noopener noreferrer"
                    ...
                    <div className="flex items-center">
                      <span className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-3">
                        <svg className="w-3.5 h-3.5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
                          <path d="M10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 6 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z"/>
                    ...
                    <div className="flex items-center">
                      <span className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-3">
                        <svg className="w-3.5 h-3.5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M7.979 5v1.586a3.5 3.5 0 0 1 3.082-1.574C14.3 5.012 15 7.03 15 9.655V15h-3v-4.738c0-1.13-.229-2.584-1.995-2.584-1.713 0-2.005 1.23-2.005 2.5V15H5.009V5h2.97ZM3 2.487a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/>
